...
| Özellik                        | Elroq 60 e-Prestige           |
|--------------------------------|-------------------------------|
| Yakıt Tipi                     | Elektrik                      |
| Batarya Kapasitesi (brüt)      | 63 kWh                        |
| Batarya Kapasitesi (net)       | 59 kWh                        |
| Maksimum Güç                   | 150 kW (204 PS)               |
| Maksimum Tork                  | 310 Nm                        |
| Maksimum Hız                   | 160 km/h                      |
| İvmelenme (0–100 km/h)         | 8,0 s                         |
| Menzil (WLTP Kombine)          | 422 km                        |
| Menzil (WLTP Şehir İçi)        | 543 km                        |
| Enerji Tüketimi (WLTP Kombine) | 16,1 kWh/100 km               |
| AC Şarj (11 kW, 0–100%)        | 6 saat 30 dakika              |
| DC Şarj (165 kW, 10–80%)       | 24 dakika                     |
| WLTP CO₂ Emisyonu              | 0 g/km                        |
| Güç Aktarımı                   | Arkadan itiş (RWD)            |
| Uzunluk/Genişlik/Yükseklik     | 4.488 / 1.884 / 1.632 mm      |
| Dingil Mesafesi                | 2.770 mm                      |
| Yerden Yükseklik               | 186 mm                        |
| Bagaj Hacmi                    | 470 – 1.580 L                 |
| Lastikler                      | 235/55 R19                    |
| Ağırlık (sürücü dahil)         | 1.978 – 2.033 kg              |
| Dönüş Çapı                     | 9,3 m                         |
| Sürtünme Katsayısı             | 0,26                          |
