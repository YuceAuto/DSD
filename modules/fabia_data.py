...
FABIA_PREMIUM_MD = """\
| Parça Kodu | ŠKODA FABIA PREMIUM OPSİYONEL DONANIMLAR                                                      | Yetkili Satıcı Net Satış Fiyatı (TL)         | Yetkili Satıcı Anahtar Teslim Fiyatı (TL) (%80 ÖTV)          |
|------------|-----------------------------------------------------------------------------------------------|----------------------------------------------|--------------------------------------------------------------|
...
| Parça Kodu | ŠKODA FABIA MONTE CARLO OPSİYONEL DONANIMLAR                                                 | Yetkili Satıcı Net Satış Fiyatı (TL)         | Yetkili Satıcı Anahtar Teslim Fiyatı (TL) (%80 ÖTV)          |
|------------|----------------------------------------------------------------------------------------------|----------------------------------------------|--------------------------------------------------------------|
| Exc        | Exclusive Renkler                                                                            | 13,889                                       | 30,000                                                       |
| Met        | Metalik Renkler                                                                              | 9,259                                        | 20,000                                                       |
| PE4        | Sürücü Diz Hava Yastığı & Arka Yan Hava Yastıkları                                           | 16,204                                       | 35,000                                                       |
